    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Quantity of string is: " + quanString.quantityString +
                "\nQuantity of empty string is:" + quanString.quantityEmptyString +
                "\nQuantity of string with comments is: " + quanString.quantityComments +
                "\nQuantity of string code C# is: " + quanString.quantityCode +
                "\nQuantity of string with mixed comments is: " + quanString.quantityMixedComments);
            //Console.Read();
        }
    }
}
